			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar">
						Setelah Meminum Minuman disini Rasanya seperti di Langit
					</div>
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="authLogin.php" class="flex-c-m trans-04 p-lr-25">
							Login
						</a>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="images/product1.jpg" alt="IMG-PRODUCT" width="350px" height="250px">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="images/product2.jpg" alt="IMG-PRODUCT"width="350px" height="250px">
